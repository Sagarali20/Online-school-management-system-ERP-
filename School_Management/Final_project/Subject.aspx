       ...
       <div class="row">
            <div class="col-lg-12 mx-auto">
				...
				<div class=" d-md-flex input-group justify-content-end ">
						 <asp:TextBox ID="text_serch" runat="server" CssClass="form-control  col-md-2 " placeholder="Subject_Id"></asp:TextBox>
                    ...
                    <div class="   mt-3">
						<asp:Button ID="insert" runat="server" Text="Add_New" CssClass="btn btn-info form-control col-md-2  mt-2" Enabled="False" />
						<asp:Button ID="Savesubj" runat="server" Text="Save_Subject" CssClass="btn btn-info form-control col-md-2  mt-2" Enabled="False" />
			     		<asp:Button ID="update" runat="server" Text="Update" CssClass="btn btn-info form-control col-md-2  mt-2" Enabled="False" />	
						<asp:Button ID="Delete" runat="server" Text="Delete" CssClass="btn btn-info form-control col-md-2  mt-2" Enabled="False" />
						<asp:Button ID="cancel" runat="server" Text="Cancle" CssClass="btn btn-info form-control col-md-2  mt-2" />
