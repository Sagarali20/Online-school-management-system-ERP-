       ...
       <div class="row">
            <div class="col-lg-6 mx-auto">
                <div class="team-member bg-dark">
					<br />
					<h1 class="text-white font-italic text-center">Login</h1>
					<br />
				
                       <div class="d-flex justify-content-center mt-3">
						<asp:TextBox ID="TextBox1" runat="server" CssClass="form-control  col-md-6" placeholder="Enter Your User_Name"></asp:TextBox>
                       </div>
					     <div class="d-flex justify-content-center mt-3 ">
