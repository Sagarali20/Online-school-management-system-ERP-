			...
			<div class="container">
				...
				<ul class="navbar-nav mx-auto" >
                    ...
                    <asp:TextBox ID="Searchtext" CssClass="form-control col-2" placeholder="Search_std_Id" Height="37px" runat="server"></asp:TextBox>
                              ...
                              <asp:DropDownList ID="DropDownList4" runat="server" CssClass="form-control col-md-2" Height="37px" AutoPostBack="true" OnSelectedIndexChanged="DropDownList4_SelectedIndexChanged" >
                            ...
                            <asp:DropDownList ID="DropDownList5" runat="server"  CssClass="form-control col-md-2" Height="37px">
