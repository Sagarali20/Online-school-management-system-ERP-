<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm4.aspx.cs" Inherits="Final_project.WebForm4" %>
		...
		<nav class="navbar fixed-top navbar-light bg-light navbar-expand-md">
			<div class="container">
				...
				<ul class="navbar-nav mx-auto" >
                    ...
                    <asp:TextBox ID="Searchtext" CssClass="form-control col-2" placeholder="Search_std_Id" runat="server" AutoPostBack="True"></asp:TextBox>
                ...
                <div class="team-member bg-dark">
					...
					<br />
                      <div class="d-flex justify-content-center mt-1">
                          ...
                          <div class="d-flex justify-content-center mt-1">
							 <asp:DropDownList ID="DropDownList2" runat="server" CssClass="form-control col-md-9" AutoPostBack="True" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged" >
