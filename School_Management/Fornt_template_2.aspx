<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Fornt_template_2.aspx.cs" Inherits="Final_project.Fornt_template_2" %>
...
<head>
	...
	<!-- Stylesheets -->
	<link rel="stylesheet" href="Tem2/css/bootstrap.min.css"/>
	<link rel="stylesheet" href="Tem2/css/font-awesome.min.css"/>
	<link rel="stylesheet" href="Tem2/css/themify-icons.css"/>
	<link rel="stylesheet" href="Tem2/css/magnific-popup.css"/>
	<link rel="stylesheet" href="Tem2/css/animate.css"/>
	<link rel="stylesheet" href="Tem2/css/owl.carousel.css"/>
	<link rel="stylesheet" href="Tem2/css/style.css"/>
...
<body>
	...
	<nav class="nav-section">
		<div class="container">
			...
			<div class="nav-right">
				...
				<a href="login.aspx"><strong>Authories</strong></a>
			</div>
			<ul class="main-menu">
                          	<a href="index.html" class="site-logo"><img src="Tem2/img/fact-bg.jpg" height="50px" alt=""></a>

				<li class="active"><a href="/Fornt_template_2">Home</a></li>
	...
	<section class="hero-section">
		<div class="hero-slider owl-carousel">
			<div class="hs-item set-bg" data-setbg="Tem2/img/hero-slider/img_5.jpg">
				<div class="hs-text">
					<div class="container">
						<div class="row">
							<div class="col-lg-8">
								<div class="hs-subtitle text-light" >Award Winning UNIVERSITY</div>
								
								<div class="site-btn table-hover"><a href="UI/Student_portal.aspx" target="_blank" class=" text-light">MySchool</a></div>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-lg-8">
								...
								<div class="site-btn"><a href="UI/Student_portal.aspx" target="_blank" class=" text-light">MySchool</a></div>
							</div>
						</div>
					</div>
				</div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
	...
	<!--====== Javascripts & Jquery ======-->
	<script src="Tem2/js/jquery-3.2.1.min.js"></script>
	<script src="Tem2/js/owl.carousel.min.js"></script>
	<script src="Tem2/js/jquery.countdown.js"></script>
	<script src="Tem2/js/masonry.pkgd.min.js"></script>
	<script src="Tem2/js/magnific-popup.min.js"></script>
	<script src="Tem2/js/main.js"></script>
